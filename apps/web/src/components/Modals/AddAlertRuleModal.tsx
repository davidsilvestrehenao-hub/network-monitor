...
export const AddAlertRuleModal: Component<AddAlertRuleModalProps> = props => {
  ...
  const getMetricDescription = (currentMetric: string): string => {
  ...
  const getConditionDescription = (currentCondition: string): string => {
