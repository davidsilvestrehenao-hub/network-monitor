...
export const AlertRuleCard: Component<AlertRuleCardProps> = props => {
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md transition-shadow">
      ...
      <div class="flex space-x-2">
        ...
        <button
          type="button"
          onClick={() => props.onEdit()}
          class="flex-1 py-2 px-3 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-md text-sm font-medium hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
        >
          Edit
        </button>
      </div>
