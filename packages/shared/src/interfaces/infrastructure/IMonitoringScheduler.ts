/**
 * @deprecated This interface mixed traditional service patterns with microservice patterns.
 * Use IMonitoringService for traditional Router → Service → Repository pattern.
 * Use IMonitorMicroservice for standalone microservice applications.
 *
...
/**
 * @deprecated Use IMonitoringService for traditional services or IMonitorMicroservice for microservices
 */
export interface IMonitoringScheduler extends IBackgroundService {
  // Target management
