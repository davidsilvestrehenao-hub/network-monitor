...
describe("NotificationService", () => {
  ...
  beforeEach(async () => {
    ...
    notificationService = new NotificationService(
      ...
      mockEventBus as unknown as IEventBus, // Type assertion for mock compatibility
      mockLogger
    );
  });
  ...
  afterEach(() => {
    ...
    mockEventBus.emitDynamic.mockClear();
  });
  ...
  describe("Push Notifications", () => {
    describe("sendPushNotification", () => {
      it("should send push notification to all user subscriptions", async () => {
        ...
        // Should emit NOTIFICATION_CREATED first
        expect(mockEventBus.emitDynamic).toHaveBeenCalledWith(
          "NOTIFICATION_CREATED",
          {
            id: 1,
        ...
        // Then emit PUSH_NOTIFICATION_SENT
        expect(mockEventBus.emitDynamic).toHaveBeenCalledWith(
  ...
  describe("Event Handlers", () => {
    describe("handleAlertTriggered", () => {
      it("should send push notification when alert is triggered", async () => {
        ...
        // Emit the event
        mockEventBus.emitDynamic("ALERT_TRIGGERED", eventData);
    ...
    describe("handleIncidentCreated", () => {
      it("should send push notification when incident is created", async () => {
        ...
        // Emit the event
        mockEventBus.emitDynamic("INCIDENT_CREATED", eventData);
