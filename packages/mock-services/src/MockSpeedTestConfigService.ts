import type { SpeedTestUrl } from "@network-monitor/shared";
import type { ILogger } from "@network-monitor/shared";

// Define the interfaces locally since they're not exported from shared
interface SpeedTestUrlConfig {
  urls: SpeedTestUrl[];
...
interface SpeedTestUrlSelection {
  selectedUrl: SpeedTestUrl;
  fallbackUrls: SpeedTestUrl[];
  selectionReason: string;
}

interface ISpeedTestConfig {
...
export class MockSpeedTestConfigService implements ISpeedTestConfig {
