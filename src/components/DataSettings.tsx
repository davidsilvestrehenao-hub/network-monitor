    ...
    <div class="space-y-6">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <p class="text-xs text-gray-500">Automatically clean up old data</p>
        </div>
      </div>

      <div class="space-y-4">
        <h4 class="text-sm font-medium text-gray-700">Data Management</h4>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <label class="flex items-center justify-center px-4 py-2 bg-green-100 text-green-700 rounded-md hover:bg-green-200 transition-colors cursor-pointer">
            <svg
              class="h-5 w-5 mr-2"
              fill="none"
              viewBox="0 0 24 24"
